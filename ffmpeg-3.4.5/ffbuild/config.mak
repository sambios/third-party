...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/hsyuan/lab/ffmpeg-binary-android/build_scripts/x86_64 --target-os=linux --arch=x86_64 --cross-prefix=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android- --enable-cross-compile --sysroot=/opt/android-ndk-r14b/platforms/android-21/arch-x86_64/ --pkg-config=/usr/bin/pkg-config --pkg-config-flags=--static --enable-pic --enable-small --enable-gpl --disable-shared --enable-static --enable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-protocols --enable-protocol='file,pipe' --disable-demuxers --disable-muxers --enable-demuxer='aac,avi,dnxhd,flac,flv,gif,h261,h263,h264,image2,matroska,webm,mov,mp3,mp4,mpeg,ogg,srt,wav,webvtt,gif,image2,image2pipe,mjpeg' --enable-muxer='3gp,dnxhd,flac,flv,gif,image2,matroska,webm,mov,mp3,mp4,mpeg,ogg,opus,srt,wav,webvtt,ipod,gif,image2,image2pipe,mjpeg' --disable-encoders --disable-decoders --enable-encoder='aac,dnxhd,flac,flv,gif,libmp3lame,libopus,libshine,libvorbis,mpeg4,png,mjpeg,gif,srt,subrip,webvtt' --enable-decoder='aac,aac_at,aac_fixed,aac_latm,dnxhd,flac,flv,h261,h263,h263i,h263p,h264,vp8,vp9,libopus,libvorbis,mp3,mpeg4,wavpack,png,mjpeg,gif,pcm_s16le,pcm_s16be,rawvideo,srt,webvtt' --enable-libshine --enable-libmp3lame --enable-libopus --enable-libvorbis --enable-bsf=aac_adtstoasc --disable-doc --disable-linux-perf
...
ARCH=x86
INTRINSICS=none
CC=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
CXX=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-g++
AS=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
OBJCC=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
LD=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
DEPCC=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-ranlib -D
STRIP=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-strip
STRIPTYPE=direct
NVCC=nvcc
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=--sysroot=/opt/android-ndk-r14b/platforms/android-21/arch-x86_64/  --sysroot=/opt/android-ndk-r14b/platforms/android-21/arch-x86_64/ -isysroot /opt/android-ndk-r14b/platforms/android-21/arch-x86_64/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=-fomit-frame-pointer -fPIC -march=x86-64 -Os -O3 -I/home/hsyuan/lab/ffmpeg-binary-android/build_scripts/x86_64/include --sysroot=/opt/android-ndk-r14b/platforms/android-21/arch-x86_64/ -fPIE    -std=c11 -fomit-frame-pointer -fPIC -pthread -I/home/hsyuan/lab/ffmpeg-binary-android/build_scripts/x86_64/include/opus -I/home/hsyuan/lab/ffmpeg-binary-android/build_scripts/x86_64/include/opus -I/home/hsyuan/lab/ffmpeg-binary-android/build_scripts/x86_64/include -I/home/hsyuan/lab/ffmpeg-binary-android/build_scripts/x86_64/include -I/home/hsyuan/lab/ffmpeg-binary-android/build_scripts/x86_64/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=-fomit-frame-pointer -fPIC -march=x86-64 -Os -O3 -I/home/hsyuan/lab/ffmpeg-binary-android/build_scripts/x86_64/include --sysroot=/opt/android-ndk-r14b/platforms/android-21/arch-x86_64/ -fPIE    -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=   -fPIC -g
...
LD_PATH=-L
DLLTOOL=
WINDRES=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-windres
DEPWINDRES=/opt/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/linux-x86_64/bin/x86_64-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS=-L/home/hsyuan/lab/ffmpeg-binary-android/build_scripts/x86_64/lib -fPIE -pie   --sysroot=/opt/android-ndk-r14b/platforms/android-21/arch-x86_64/ -isysroot /opt/android-ndk-r14b/platforms/android-21/arch-x86_64/ -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
